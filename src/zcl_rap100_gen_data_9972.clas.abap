CLASS zcl_rap100_gen_data_9972 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_9972 IMPLEMENTATION.
...
*   clear data
    DELETE FROM zranko_test.

    "insert travel demo data
    INSERT zrap100_trav9972  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table zrap100_trav9972. | ).
  ENDMETHOD.
ENDCLASS.
